<section class="content-header">
	<section class="content">
		<div class="row">
			<div class="well col-xs-12 col-sm-12 col-md-10 col-md-offset-1 col-lg-10 col-lg-offset-1">
				<p class="text-center"><b><?php echo $this->lang->line("Youtube Video Tracking Report")." - ".$this->lang->line("Search Panel"); ?></b></p>
				<form method="POST">
    ...
    $(document.body).on('click','#search',function(e){
    		...
    		if(keyword == '' || from_date == '' || to_date == '')
    			...
    			$.ajax({
			        type:'POST',
			        async:false,
			        url:"<?php echo site_url();?>"+'video_position_tracking/keyword_position_report_data',
